...
public class PoemAdapter implements ListAdapter {

    private Context context;
    private List<Poem> values;
    private Resources res;

    PoemAdapter(Context c, Resources r, List<Poem> v){
        context = c;
        res = r;
        values = v;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap b = decodeSampledBitmapFromPath(position, 40, 40);
